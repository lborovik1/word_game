...
======================================================
Please add a restart button to the grammar practice 
instead of the "Home" button. So that we could return 
to the home screen - and choose a different game or test
======================================================
We have games, tests, and grammar parts.
In all of them we have a black button to return to the home screen.
But in some places it is called "Restart" and in some - "Home".
Please make it "Home" everywhere.
Also please change the color from black to something
more pleasing. And make the visual of home more visible.
======================================================
The home page has the title: "Word Learning".
And subtitle: "Learn vocabulary or test your English level".

Please remove the title.
And change title to:
    "Learn English - and Test Your Level"
======================================================
On the home page we currently have 3 buttons in this order:
    Word Matching Game
    English Level Test
    Grammar Practice

Please change the order to this:
    Word Matching Game
    Grammar Practice
    English Level Test
======================================================
Change the font on the top tile of the home page to match with the font on the buttons
======================================================
Please make the similar font change in all game parts.
======================================================
